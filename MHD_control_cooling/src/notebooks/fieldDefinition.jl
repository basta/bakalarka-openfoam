...
cellsText = read("../../../2d-example/0/C", String)
...
begin
	A_filtered = (A)[1:size(A,1)]
	cells_filtered = cells[1:end]
	mag = 0.01
	arrows(
...
manifest_format = "2.0"
project_hash = "c2293b36582728467bbd8326540bc2f671a19eea"
...
git-tree-sha1 = "6c66fe771b7d4563a0f4db48f5573b245768dc86"
