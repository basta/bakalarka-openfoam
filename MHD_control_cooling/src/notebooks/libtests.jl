...
# ╔═╡ f8c7f6bc-1d13-11f0-3cab-b79aa3fc1799
using SimplePlutoInclude, BlockArrays, JuMP, OSQP

# ╔═╡ 5d913d91-e660-423e-8a13-be43acd485f5
@plutoinclude "../mpc_lib.jl"

# ╔═╡ 8bdd9ff4-386b-40f1-a18b-554e66a1026b
X_data = rand(2,5)

# ╔═╡ d66309fd-31c6-401f-9b60-4907369d5d80
U_data = rand(1, 5)

# ╔═╡ 66727072-bdf4-43ea-88a3-b0ba9912b995
create_delay_state(X_data, U_data, 1)
...
manifest_format = "2.0"
project_hash = "5b14e46b12cbe769e12bc71c677a5806c7e0a01f"
