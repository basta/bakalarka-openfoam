...
# ╔═╡ a6d4a0e6-f69a-11ef-0a7a-1b152023270f
using JLD, JLD2, LinearAlgebra

# ╔═╡ 1958d639-cbe7-497b-a97b-76b97cdbc7e5
begin
	path = "../../data/forceFields/"
	name = "E1"
end

# ╔═╡ 0e3f5e1d-f6c4-47e8-b923-246c4c36e531
data = load(joinpath("../../data/forceFields/", "$name.jld"))

# ╔═╡ d330a89a-92ec-427c-8845-26226502418d
data["coords"] = data["coords"].parent
...
manifest_format = "2.0"
project_hash = "293f4f24e947280a018a625521757c9d8489ab37"
